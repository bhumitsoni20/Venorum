...
const Home = () => {
  ...
  useGSAP(() => {
    ...
    gsap.to(heroTextRef.current, {
      ...
      opacity: 0,
      scale: 5, // Massive scale creates fly-through effect
      ease: 'power1.in',
      scrollTrigger: {
    ...
    tl2.to(ring360Ref.current, { rotation: 360, ease: "none" }, 0)
       .fromTo(text360Ref.current, { opacity: 0, y: 50 }, { opacity: 1, y: 0, duration: 0.3 }, 0.1)
    ...
    gsap.set([gem1Ref.current, gem2Ref.current, gem3Ref.current], { x: window.innerWidth, opacity: 0, scale: 0.5 });
    
    // Gem 1 Sequence
    tl3.to(gem1Ref.current, { x: 0, opacity: 1, scale: 1, duration: 1 })
       .to(gemBaseRef.current, { filter: 'drop-shadow(0px 0px 20px rgba(255,0,0,0.5))' }, "<")
       .to(gem1Ref.current, { opacity: 0, scale: 2, duration: 0.5 });

    // Gem 2 Sequence
    tl3.to(gem2Ref.current, { x: 0, opacity: 1, scale: 1, duration: 1 })
       .to(gemBaseRef.current, { filter: 'drop-shadow(0px 0px 20px rgba(0,0,255,0.5))' }, "<")
       .to(gem2Ref.current, { opacity: 0, scale: 2, duration: 0.5 });

    // Gem 3 Sequence
    tl3.to(gem3Ref.current, { x: 0, opacity: 1, scale: 1, duration: 1 })
       .to(gemBaseRef.current, { filter: 'drop-shadow(0px 0px 20px rgba(0,255,0,0.5))' }, "<");


    /* SECTION 4: Customization Typewriter Effect */
    gsap.fromTo(typeTextRef.current, 
      { width: 0 }, 
      { 
        width: '100%', 
        duration: 2, 
  ...
  return (
    <div ref={mainRef} className="bg-luxury-black text-luxury-white overflow-hidden">
      
      {/* ================= SECTION 1: HERO & INTRO ================= */}
      <section ref={sec1Ref} className="relative h-screen w-full flex items-center justify-center">
        ...
        <div className="absolute inset-0 z-0">
          ...
          >
             <source src="https://cdn.pixabay.com/video/2021/08/21/85848-592186716_tiny.mp4" type="video/mp4" />
          </video>
      ...
      <section ref={sec2Ref} className="relative h-screen w-full bg-luxury-black overflow-hidden flex items-center border-t border-luxury-gold/10">
         ...
         <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 items-center relative z-10 h-full">
            ...
            <div ref={text360Ref} className="flex flex-col justify-center px-6 md:px-16 text-center md:text-left opacity-0 translate-y-10">
               <p className="text-luxury-gold text-xs uppercase tracking-widest mb-4">Master Craftsmanship</p>
               <h2 className="text-4xl md:text-6xl font-serif mb-6 leading-tight">Every Angle,<br /><span className="italic">Perfected.</span></h2>
               <p className="text-gray-400 font-light leading-relaxed mb-8">
                 Forged by heritage masters, our pieces demand attention from every perspective. We dedicate upwards of 200 hours carving the exact facets needed to capture absolute brilliance.
               </p>
      ...
      {/* ================= SECTION 3: DYNAMIC GEM CHANGE ================= */}
      <section ref={sec3Ref} className="relative h-screen w-full bg-luxury-black overflow-hidden border-t border-luxury-gold/10">
         <div className="absolute inset-0 flex flex-col items-center justify-center pt-20">
            <h2 className="text-3xl md:text-5xl font-serif mb-2">Build Your Legacy</h2>
            <p className="text-gray-400 tracking-wider text-sm uppercase mb-16">Witness the transformation</p>
            ...
            <div className="relative w-64 h-64 md:w-96 md:h-96 flex items-center justify-center">
               ...
               <div ref={gem1Ref} className="absolute inset-0 z-20 flex justify-center items-center">
                  ...
                  <span className="absolute -bottom-10 text-red-400 uppercase tracking-widest text-xs font-bold bg-luxury-black/80 px-3 py-1">Imperial Ruby</span>
               </div>
               
               <div ref={gem2Ref} className="absolute inset-0 z-30 flex justify-center items-center">
                  ...
                  <span className="absolute -bottom-10 text-blue-400 uppercase tracking-widest text-xs font-bold bg-luxury-black/80 px-3 py-1">Deep Sapphire</span>
               </div>

               <div ref={gem3Ref} className="absolute inset-0 z-40 flex justify-center items-center">
                  ...
                  <span className="absolute -bottom-10 text-green-400 uppercase tracking-widest text-xs font-bold bg-luxury-black/80 px-3 py-1">Verdant Emerald</span>
               </div>

            </div>

            <div className="absolute bottom-20 w-full flex justify-center">
               <Link to="/shop" className="bg-luxury-gold text-luxury-black hover:bg-luxury-white px-10 py-4 uppercase tracking-widest text-xs font-semibold shadow-[0_0_20px_rgba(212,175,55,0.3)] transition-all">
                 Configure Yours
               </Link>
            </div>
         </div>
      ...
      <section ref={sec4Ref} className="relative py-32 bg-luxury-gray border-t border-luxury-gold/5 flex flex-col items-center justify-center font-serif">
         <div className="container mx-auto px-6 text-center z-10 glass border border-luxury-gold/10 p-16 max-w-4xl relative overflow-hidden rounded-sm">
            ...
            <div className="inline-block relative mb-12">
               <h2 ref={typeTextRef} className="text-4xl md:text-6xl text-luxury-white overflow-hidden whitespace-nowrap border-r-2 border-luxury-gold pr-2 m-0 mx-auto w-0">
                  Customize More?
               </h2>
            </div>
            
            <p className="text-gray-400 font-sans tracking-wide mb-12 max-w-xl mx-auto font-light">
               Design a piece specifically for your lineage. Connect instantly with our dedicated master artisans to sketch your legacy.
            </p>
      ...
      <section ref={sec5Ref} className="py-32 bg-luxury-black relative border-t border-luxury-gold/5">
         <div className="container mx-auto px-6">
            <div className="flex justify-between items-end mb-16">
               <div>
                  <h2 className="text-4xl md:text-5xl font-serif mb-4">Collections</h2>
                  <p className="text-luxury-gold text-xs uppercase tracking-widest">Select your category</p>
               </div>
               <Link to="/shop" className="hidden md:inline-flex items-center space-x-2 text-xs uppercase tracking-widest text-gray-400 hover:text-luxury-gold transition-colors border-b border-gray-600 hover:border-luxury-gold pb-1">
                 <span>Show All</span>
                 <ArrowRight size={14} />
               </Link>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
               {[
                 { title: 'Jewelry for Women', img: 'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?q=80&w=600&auto=format&fit=crop' },
                 { title: 'Jewelry for Men', img: 'https://images.unsplash.com/photo-1611591437281-460bfbe1220a?q=80&w=600&auto=format&fit=crop' },
                 { title: 'Jewelry for Kids', img: 'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?q=80&w=600&auto=format&fit=crop' },
               ].map((cat, i) => (
                  <div 
                    key={i} 
                    ref={addToCardsRef} 
                  ...
                  >
                     <img src={cat.img} alt={cat.title} className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110 opacity-70 group-hover:opacity-100" />
            ...
            <div className="mt-12 text-center md:hidden">
              <Link to="/shop" className="inline-flex items-center space-x-2 text-xs uppercase tracking-widest border border-luxury-gold/50 px-8 py-3 text-luxury-white">
      ...
      <section className="py-40 bg-[url('https://images.unsplash.com/photo-1601121141461-9d6647bca1ed?q=80&w=2000&auto=format&fit=crop')] bg-cover bg-center bg-fixed relative border-t border-luxury-gold/20">
         ...
         <div className="container mx-auto px-6 relative z-10 text-center flex flex-col items-center">
            ...
            <ShieldCheck size={64} strokeWidth={1} className="text-luxury-gold mb-8 opacity-80" />
            ...
            >
               ...
               <span className="italic text-luxury-gold text-3xl md:text-5xl">100% Transparency & Quality</span>
            </motion.h2>
            
            <p className="text-gray-300 font-light max-w-2xl mx-auto leading-relaxed mb-12">
               From ethical sourcing to lifelong warranties, every piece from Venorum is certified globally and backed by our master artisan guarantee. Join our society to preserve your legacy forever.
            </p>
